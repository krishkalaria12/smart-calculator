...
pub fn cases() -> Vec<Case> {
    vec![
        ...
        case(
            ...
            Some("unit"),
            "freezing point F to C",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "212 fahrenheit to celsius",
            Some("unit"),
            "boiling point F to C",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
        ...
        case(
            "1 MW to kW",
            Some("unit"),
            "megawatt to kilowatts",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "1 GW to MW",
            Some("unit"),
            "gigawatt to megawatts",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "746 W to hp",
        ...
        case(
            ...
            Some("unit"),
            "natural: convert X to Y",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "10 kilometers to miles",
            Some("unit"),
            "natural: full unit names",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "100 centimeters to meters",
            Some("unit"),
            "natural: centimeters full name",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "5 kilograms to pounds",
            Some("unit"),
            "natural: kilograms full name",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "1 liter to milliliters",
            Some("unit"),
            "natural: liter full name",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "60 miles per hour to km/h",
            Some("unit"),
            "natural: miles per hour",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "1 meter to feet",
            Some("unit"),
            "natural: meter to feet",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "1 foot to meter",
            Some("unit"),
            "natural: foot singular",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "2 feet to meters",
        ...
        case(
            ...
            Some("unit"),
            "natural: inch singular",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "12 inches to feet",
            Some("unit"),
            "natural: inches plural",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
        ...
        case(
            ...
            Some("unit"),
            "natural: mile singular",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "5 miles to km",
            Some("unit"),
            "natural: miles plural",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "1 yard to meters",
        ...
        case(
            "2 gallons to liters",
            Some("unit"),
            "natural: gallons plural",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "1 teaspoon to tablespoon",
            Some("unit"),
            "natural: teaspoon full",
            ExpectedOutcome::Ok("unit"),
        ),
        case(
            "1 tablespoon to teaspoon",
            Some("unit"),
            "natural: tablespoon full",
            ExpectedOutcome::Ok("unit"),
        ),
